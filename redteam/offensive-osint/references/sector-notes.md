...
### 47.8 Non-regulated US sectors — see companion reference

For mass recon of **non-regulated US small/medium businesses** (landscaping, pool services, roofing, HVAC, auto repair, accounting, property management, photography, etc.), see the companion file `sector-discovery-mass-recon.md` in this skill's references directory. That file covers parallel batch testing methodology, false-positive filtering, empirical sector vulnerability rankings, and target compilation workflow for the sectors where compliance burden is absent and shared WordPress hosting without WAF is the norm.
